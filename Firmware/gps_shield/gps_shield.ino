/******************************************************************************
  For this example I decided to use SoftwareSerial to communicate with the GPS
  module on pins 8 and 9, then communicates over SPI to log that data to a uSD card.
  ...
  This is an UNO sketch. Se more Arduino 
...
#define sd_pin 8 // uSD card CS pin (pin 8 on Duinopeak GPS Logger Shield)
...
////////////////////////////////////////////////
// Definindo Porta Serial no Arduino GPS Shield//
////////////////////////////////////////////////
// If you're using an Arduino Uno, Mega, RedBoard, or any board that uses the
// 0/1 UART for programming/Serial monitoring, use SoftwareSerial:
...
// Definir a porta do monitor serial usando 'Serial'
